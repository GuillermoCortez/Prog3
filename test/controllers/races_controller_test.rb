...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { championship_id: @race.championship_id, circuit_id: @race.circuit_id, name: @race.name } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { championship_id: @race.championship_id, circuit_id: @race.circuit_id, name: @race.name } }
